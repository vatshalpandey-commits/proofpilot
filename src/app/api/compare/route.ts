...
export async function POST(request: Request) {
  try {
    ...
    const proofRun = (async () => {
      ...
      const result = await runAgent(question, proofModel, createResearchToolRegistry({ tavilyApiKey }), { maxSteps: 5, toolTimeoutMs: 10_000, modelTimeoutMs: 50_000, maxRunMs: 190_000, maxModelFailures: 0 });
