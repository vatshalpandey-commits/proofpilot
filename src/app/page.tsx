...
export default function Home() {
  ...
  return <main className="shell">
    ...
    <footer><span><ShieldCheck size={12} />Custom plan → act → observe loop</span><span><TerminalSquare size={12} />Five-decision safety limit</span><span><Radio size={12} />Runtime events recorded · injected faults labeled</span><span>Gemini + Groq fallback + Tavily</span></footer>
  </main>;
}
